...
function Navbar() {
  return (
    <div className="fixed w-full z-10 top-0">
      <div className="flex w-full relative bg-white justify-between items-center py-5 px-3 border-t-4 border-t-[--grey] lg:px-28 lg:py-3">
        <AiOutlineMenu className="text-[--text] lg:text-5xl hover:text-[--text-hover] cursor-pointer" />
        <img
          src={logo}
          alt="logo"
          className="w-full max-w-[200px] lg:max-w-[350px] lg:pl-10 cursor-pointer transition ease-in delay-200 hover:scale-95"
        />
